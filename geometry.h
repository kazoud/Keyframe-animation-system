...
struct VertexPN {
  ...
  VertexPN(const glm::dvec3& pos, const glm::dvec3& normal)
...
struct VertexPNX {
  glm::vec3 p, n;
  glm::vec2 x; // texture coordinates
  ...
  VertexPNX(const glm::vec3& pos, const glm::vec3& normal, const glm::vec2& texCoords)
    : p(pos), n(normal), x(texCoords) {}

  VertexPNX(const glm::dvec3& pos, const glm::dvec3& normal, const glm::dvec2& texCoords)
...
struct VertexPNTBX {
  ...
  VertexPNTBX(const glm::vec3& pos, const glm::vec3& normal,
              const glm::vec3& tangent, const glm::vec3& binormal, const glm::vec2& texCoords)
    : p(pos), n(normal), x(texCoords), t(tangent), b(binormal) {}

  VertexPNTBX(const glm::dvec3& pos, const glm::dvec3& normal,
              const glm::dvec3& tangent, const glm::dvec3& binormal, const glm::dvec2& texCoords)
    : p(pos[0], pos[1], pos[2]), n(normal[0], normal[1], normal[2]), x(texCoords[0], texCoords[1]), 
